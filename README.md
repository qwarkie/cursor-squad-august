...
```bash
npm run setup   # installs frontend and backend deps, applies migrations
...
No tests, CI, or Docker — deliberately, to keep the base minimal. Add them as the project needs them.
